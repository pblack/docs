...
Since you're already using git for hosting, why not also host your code there? If you're hosting with github-pages, also using github for your version control is a great workflow. We have a doc you can checkout (link needs to be added, if it's not bug [@scottgallant](https://twitter.com/scottgallant) on twitter, because he was suppoed to fix it).